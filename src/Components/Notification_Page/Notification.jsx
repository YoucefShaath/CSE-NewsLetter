...
export default function NotificationPageDark()
{
  return (
    <div className="flex flex-col relative overflow-hidden bg-dark-blue min-h-screen py-8 ">
      ...
      <div className="flex items-center ml-[97px] mt-[177px] mb-[67px] ">
        <div className="w-2.5 h-[60px] bg-light-blue blur-[2px] mr-4"></div>
        <div className="text-white text-[48px] normal-case flex-1">Notifications</div>
      </div>
      ...
      <div className="flex items-center flex-col">
        <div className="relative"> 
          ...
          <div className="absolute flex flex-row justify-between items-center w-[800px] top-5 left-[140px] ">
            <button className="shrink-0 text-white  text-[36px] capitalize border-none bg-none p-0 m-0 cursor-pointer">All</button>
            <button className="shrink-0 text-white  text-[36px] capitalize border-none bg-none p-0 m-0 cursor-pointer">Unread</button>
            <button className="shrink-0 text-white  text-[36px] capitalize border-none bg-none p-0 m-0 cursor-pointer">Mentions</button>
          </div>
        </div>
